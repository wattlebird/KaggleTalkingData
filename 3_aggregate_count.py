...
train.to_csv(DATA+'train/train_ready.csv', index=False)
...
test.to_csv(DATA+'train/test_ready.csv', index=False)
del test

train = pd.read_csv(DATA + 'test/train.csv', dtype=dtype, 
usecols=['ip', 'app', 'device', 'os', 'channel', 'is_attributed', 'hour', 'day'], engine='c')
...
train.to_csv(DATA+'test/train_ready.csv', index=False)
...
test.to_csv(DATA+'test/test_ready.csv', index=False)